...
GID_DINER        = 25   # row 2 col 4 in tileset — diner tile
...
def tile_gids(col, row):
    ...
    elif (bc, br) == DINER_BLOCK:
        return GID_SIDEWALK, GID_DINER
    else:
    ...
    "layers": [
        ...
        },
        {
            ...
            "objects": [
                ...
                {
                    # South-face entrance of the diner block (4,1).
                    # Interior cols 44-48, south sidewalk row 19.
                    "id": 6,
                    "name": "diner_entrance",
                    "type": "diner_entrance",
                    "x": 45 * TS,
